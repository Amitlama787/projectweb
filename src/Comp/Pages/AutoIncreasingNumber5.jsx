// src/components/AutoIncreasingNumber5.jsx

import React, { useState, useEffect } from 'react';

const AutoIncreasingNumber5 = ({ start = 1, interval = 1000, end = 5 }) => {
  const [number, setNumber] = useState(start);
  const [autoIncrementStarted, setAutoIncrementStarted] = useState(false);

  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY >= 3100 && !autoIncrementStarted) {
...
export default AutoIncreasingNumber5;
